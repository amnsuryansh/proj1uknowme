...
var questions = [{question:"whats my pet name ? " , answer:"shubham"},
...
if(score >= 5){
  ...
  console.log("try not know suryansh मेरे बारे में इतना मत सोचना, दिल में आता हूं, समझ में नहीं।")
}

var queslevelTwo = [{question:"What really makes you angry?",answer:"slow internet"},{question:"What's the most useless talent you have? ",answer:"texting"},{question:"whos my fav comedian ? ",answer:"bassi"},{question:"fav sport ? ",answer:"basketball"},{question:"fav team ? ",answer:"rcb"},{question:"fav drink ? ",answer:"water"},{question:"short or long hair ? ",answer:"long"}];
